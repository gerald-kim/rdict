...
public class HistoryTest extends TestCase {
	...
	public void testCanGoBack() {
		...
		h.addWord(new Word(1, "word", "def"));
		
		assertTrue(! h.canGoBack());
		
		h.addWord(new Word(2, "word2", "def2"));
	...
	public void testGoBack() {
		...
		h.addWord(new Word(1, "word", "def"));
		h.addWord(new Word(2, "word2", "def2"));
		h.addWord(new Word(3, "word3", "def3"));		
	...
	public void testGoBackAndAddingErasesDownstreamItems() {
		...
		h.addWord(new Word(4, "word4", "def4"));
		
		assertEquals(4, h.getWord()._id);
		assertTrue(h.canGoBack());
		assertTrue(! h.canGoForward());
