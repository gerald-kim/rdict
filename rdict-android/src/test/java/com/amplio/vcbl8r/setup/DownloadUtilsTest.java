...
import com.amplio.vcbl8r.setup.DownloadUtils;
...
public class DownloadUtilsTest extends TestCase {
	...
	private static final String MD5_TEST_FILE_PATH = "src/test/java/com/amplio/vcbl8r/setup/word.index.md5";
	...
	public void testCalculateMd5Hash() {
		...
		File f = new File("src/test/java/com/amplio/vcbl8r/setup/word.index");
	...
	public void testReadMd5File() {
		byte[] md5Hash = DownloadUtils.calcMd5Hash(new File("src/test/java/com/amplio/vcbl8r/setup/word.index"));
	...
	public void testCheckFileIntegrity() {
		File downloadedFile = new File("src/test/java/com/amplio/vcbl8r/setup/word.index");
