				...
				function saveAction()
				{
					...
					if(settings.callback) {
						...
						jQuery.ajax({
							url: settings.url,
							type: "POST",
							data: settings.update_value + '=' + encodeURIComponent(new_html) + '&' + settings.element_id + '=' + original_element.attr("id") + settings.params + '&' + settings.original_html + '=' + encodeURIComponent(original_html),
							dataType: "html",
